                        ...
                        <form id="ajaxForm" class="" action="{{route('admin.product.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dynamic_field">
                                    <tr>
                                        <td><input type="number" step="any" name="list_package[]" placeholder="Enter price" class="form-control price_list" /></td>
                                        <td><input type="text" name="list_package[]" placeholder="Enter description" class="form-control desc_list" /></td>
    ...
    $(document).ready(function() {
        ...
        $('#add').click(function() {
            ...
            $('#dynamic_field').append(
                ...
                '<td>' +
                '<input type="number" step="any" name="list_package[]" placeholder="Enter price" class="form-control price_list" />' +
                '</td>' +
                '<td>' +
                '<input type="text" name="list_package[]" placeholder="Enter description" class="form-control desc_list" />' +
                '</td>' +
                '<td>' +
