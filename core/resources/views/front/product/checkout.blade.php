                        ...
                        <div class="table">
                            ...
                            <table class="cart-table">
                                ...
                                <tbody>
                                    ...
                                    @php
                                    $product_price = App\ProductPrices::findOrFail($key);
                                    @endphp

                                    <input type="hidden" name="product_id[]" value="{{$key}}">
                                    @php
                                    $total += $item['price'] * $item['qty'];
                                    $product = App\Product::findOrFail($product_price->product_id);
                            ...
                            <div id="cartTotal">
                                <ul class="cart-total-table">
                                    ...
                                    <li class="clearfix">
                                        ...
                                        <span class="col">
                                            {{ $bex->base_currency_symbol_position == 'left' ? $bex->base_currency_symbol : '' }}<span data="{{ cartSubTotal() }}" class="subtotal" id="subtotal">{{ cartSubTotal() }}</span>{{ $bex->base_currency_symbol_position == 'right' ? $bex->base_currency_symbol : '' }}
                                        </span>
                                    </li>
                                    ...
                                    <li class="clearfix">
                                        ...
                                        <span class="col">
                                            {{ $bex->base_currency_symbol_position == 'left' ? $bex->base_currency_symbol : '' }}<span data-tax="{{ tax() }}" id="tax">{{ tax() }}</span>{{ $bex->base_currency_symbol_position == 'right' ? $bex->base_currency_symbol : '' }}
                                        </span>
                                    </li>
