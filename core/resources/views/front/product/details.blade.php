        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="product-details-content ml-60 mt-30">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <select id="price_id" name="price_id" class="form-control">
                                    <option value="" selected disabled>اختر عدد المستخدمين</option>
                                    @foreach ($product->prices as $CategoryService)
                                    <option value="{{ $CategoryService->id }}">{{ $CategoryService->description }}</option>
                                    @endforeach
                                </select>
                    ...
                    @if ($bex->catalog_mode == 0)
                    <div class="actions">
                        <form class="d-inline-block ml-2" method="post" action="{{route('add.car')}}">
                            @CSRF
                            ...
                            <button type="submit" class="main-btn ">{{__('Add To Cart')}}</button>
                        </form>
