                        ...
                        <div class="shop-thumb">
                            ...
                            <ul>
                                @if ($bex->catalog_mode == 0)
                                    ...
                                    <li><a class="cart-link" data-href="{{route('add.car',$product->id)}}" data-toggle="tooltip" data-placement="top" title="{{__('Add to Cart')}}"><i class="fas fa-shopping-cart"></i></a></li>
                                @endif
