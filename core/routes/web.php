...
Route::group(['middleware' => 'setlang'], function () {
  ...
  Route::post('/add-carts', 'Front\ProductController@addToCart')->name('add.car');

  // Route::get('/add-to-cart/{id}', 'Front\ProductController@addToCarts')->name('add.cart');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus', 'setLfmPath']], function () {
  ...
  Route::group(['middleware' => 'checkpermission:Content Management'], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Shop Management'], function () {
        ...
        Route::post('/price/delete', 'Admin\ProductController@removePrice')->name('price.delete');
